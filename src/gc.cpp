...
namespace GC {
  ...
  ItOut GCollector::GC_scan_registers(ItOut stack) {
  ...
  template <std::output_iterator ItOut>
  ItOut GCollector::GC_scan_stack(ItOut stack) {
  ...
  void GCollector::memory_dfs(m_stack& stack) {
    while(!stack.empty()) {
