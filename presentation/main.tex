...
\definecolor{title-outline}{RGB}{80, 218, 185}
\definecolor{subtitle-bg}{RGB}{249, 82, 39}
...
\setbeamertemplate{title page}{
  \begin{center}
      \fcolorbox{black}{black}{
        \contour{title-outline}{
          \color{white}
            \blackfont{\fontsize{40}{50}\selectfont \uppercase{conservative gc}}
        }
      }

      \fcolorbox{subtitle-bg}{subtitle-bg}{
          \color{white}
            \blackfont{\fontsize{15}{25}\selectfont \uppercase{the final segfault}}
      }
  \end{center}
} 
...
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{images/front-page.jpg}}
\frame{\titlepage}
}
...
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=\linewidth]{images/NOOO.jpg}
\end{column}
\end{columns}
\end{frame}
...
\begin{columns}
\begin{column}{0.5\textwidth}
\only<1->{We plugged in an AVL tree for testing and got all sorts of undefined behaivour.}
\only<2->{We fixed some UB. We saw some strange register shuffling. We saw the explosion of GoogleTest.}
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=\linewidth]{images/lockin.jpg}
\end{column}
\end{columns}
\end{frame}

\begin{frame}
\frametitle{Not so grand finale}

\begin{columns}
\begin{column}{0.5\textwidth}
\only<1->{We messed something up with scanning. Probably registers.}
\only<2->{Now we get a deterministic invalid behaivour.}
\end{column}
\begin{column}{0.5\textwidth}
\includegraphics[width=\linewidth]{images/soul.jpg}
\end{column}
\end{columns}
\end{frame}
